...
//		".xcConfirm .txtBox>p"
		var $copy = $("<a>").addClass("sgBtn").addClass("copy").attr("data-clipboard-action","copy").attr("data-clipboard-target",".xcConfirm .txtBox>p").text("复制");//复制按钮
		var $input = $("<input>").addClass("inputBox");//输入框
		$input.val(config.inputVal);
